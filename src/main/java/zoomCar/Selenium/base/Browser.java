...
public interface Browser {
	 ...
	 */
	public WebElement findElementBy(Locators locatorType, String value);	
	 ...
	 */
	public List<WebElement> findElementsBy(Locators locatorType, String value);	
	...
	/**
	 * (slightly modified)
	 * This method will switch to the Window of interest using its exact title
	...
	/**
	 * (slightly modified)
	 * This method will switch to the Window of interest using its partial title
	 * @param title The window title to be switched to first window 
	 * @throws NoSuchWindowException
	 */
